...
public class OS {
	...
	public static final int kDataBrowserDragSelect        = 1 << 0; /* � ListMgr lNoRect */
	public static final int kDataBrowserSelectOnlyOne     = 1 << 1; /* � ListMgr lOnlyOne */
	public static final int kDataBrowserResetSelection    = 1 << 2; /* � ListMgr lNoExtend */
	public static final int kDataBrowserCmdTogglesSelection = 1 << 3; /* � ListMgr lUseSense */
	public static final int kDataBrowserNoDisjointSelection = 1 << 4; /* � ListMgr lNoDisjoint */
	public static final int kDataBrowserAlwaysExtendSelection = 1 << 5; /* � ListMgr lExtendDrag */
	public static final int kDataBrowserNeverEmptySelectionSet = 1 << 6; /* � ListMgr lNoNilHilite */
